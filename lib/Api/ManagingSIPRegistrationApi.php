...
class ManagingSIPRegistrationApi
{
     ...
     * @return \backend\modules\voximplant\models\CreateSipRegistrationAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param string $outbound_proxy The outbound SIP proxy (optional)
     * @param string $password The SIP password (optional)
     * @return Array of \backend\modules\voximplant\models\CreateSipRegistrationAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function createSipRegistrationWithHttpInfo($username, $proxy, $auth_user = null, $outbound_proxy = null, $password = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\CreateSipRegistrationAPIResponse',
                '/CreateSipRegistration'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\CreateSipRegistrationAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\CreateSipRegistrationAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \backend\modules\voximplant\models\GetSipRegistrationsAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param string $username The SIP user name to filter. (optional)
     * @param bool $deactivated Set true to show the frozen SIP registrations only. (optional)
     * @return Array of \backend\modules\voximplant\models\GetSipRegistrationsAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function getSipRegistrationsWithHttpInfo($sip_registration_id = null, $username = null, $deactivated = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\GetSipRegistrationsAPIResponse',
                '/GetSipRegistrations'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\GetSipRegistrationsAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\GetSipRegistrationsAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
