...
class ManagingAdminUsersApi
{
     ...
     * @return \backend\modules\voximplant\models\AddAdminUserAPIResponse
     ...
     * @param string $admin_role_id The attaching admin role ID list separated by the &#x60;;&#x60; symbol or the &#x60;all&#x60; value. (optional)
     * @param string $admin_role_name The attaching admin role name that can be used instead of &lt;b&gt;admin_role_id&lt;/b&gt;. (optional)
     * @return Array of \backend\modules\voximplant\models\AddAdminUserAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function addAdminUserWithHttpInfo($new_admin_user_name, $admin_user_display_name, $new_admin_user_password, $admin_user_active = null, $admin_role_id = null, $admin_role_name = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\AddAdminUserAPIResponse',
                '/AddAdminUser'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\AddAdminUserAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\AddAdminUserAPIResponse', $e->getResponseHeaders());
     ...
     * @return \backend\modules\voximplant\models\GetAdminUsersAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param float $count The max returning record count. (optional)
     * @param float $offset The record count to omit. (optional)
     * @return Array of \backend\modules\voximplant\models\GetAdminUsersAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function getAdminUsersWithHttpInfo($required_admin_user_id = null, $required_admin_user_name = null, $admin_user_display_name = null, $admin_user_active = null, $with_roles = null, $with_access_entries = null, $count = null, $offset = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\GetAdminUsersAPIResponse',
                '/GetAdminUsers'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\GetAdminUsersAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\GetAdminUsersAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
