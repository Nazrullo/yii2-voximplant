...
class ManagingPushCredentialsApi
{
     ...
     * @return \backend\modules\voximplant\models\AddPushCredentialAPIResponse
     ...
     * @param int $push_provider_id The push provider id. (optional)
     * @param string $cert_file_name The parameter is required, when set &#x60;cert_content&#x60; as POST body. (optional)
     * @return Array of \backend\modules\voximplant\models\AddPushCredentialAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function addPushCredentialWithHttpInfo($external_app_name, $cert_content, $cert_password, $is_dev_mode, $push_provider_name = null, $push_provider_id = null, $cert_file_name = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\AddPushCredentialAPIResponse',
                '/AddPushCredential'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\AddPushCredentialAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\AddPushCredentialAPIResponse', $e->getResponseHeaders());
     ...
     * @return \backend\modules\voximplant\models\BindPushCredentialAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param int $application_id The application id. (required)
     * @param bool $bind Set to false for unbind. Default value is true. (optional)
     * @return Array of \backend\modules\voximplant\models\BindPushCredentialAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function bindPushCredentialWithHttpInfo($push_credential_id, $application_id, $bind = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\BindPushCredentialAPIResponse',
                '/BindPushCredential'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\BindPushCredentialAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\BindPushCredentialAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \backend\modules\voximplant\models\GetPushCredentialAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param string $external_app The push provider&#x60;s application name. (optional)
     * @param bool $with_cert Set true to get the user&#x60;s certificate. (optional)
     * @return Array of \backend\modules\voximplant\models\GetPushCredentialAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function getPushCredentialWithHttpInfo($push_credential_id = null, $push_provider_name = null, $push_provider_id = null, $application_name = null, $application_id = null, $external_app = null, $with_cert = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\GetPushCredentialAPIResponse',
                '/GetPushCredential'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\GetPushCredentialAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\GetPushCredentialAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
