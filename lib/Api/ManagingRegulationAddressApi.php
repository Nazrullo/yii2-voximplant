...
class ManagingRegulationAddressApi
{
     ...
     * @return \backend\modules\voximplant\models\CreateRegulationAddressAPIResponse
     ...
     * @param string $phone_owner_company This is the company name for the end user of the created address. It is a mandatory field if the salutation is COMPANY. (optional)
     * @param string $phone_owner_building_letter This is the building letter which can also be used for additional information on the street number. (optional)
     * @return Array of \backend\modules\voximplant\models\CreateRegulationAddressAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function createRegulationAddressWithHttpInfo($phone_category_name, $destination_country_code, $proof, $phone_owner_salutation, $phone_owner_zip_code, $phone_owner_city, $phone_owner_street, $phone_owner_building_number, $phone_owner_country_code = null, $phone_region_code = null, $phone_owner_first_name = null, $phone_owner_last_name = null, $phone_owner_company = null, $phone_owner_building_letter = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\CreateRegulationAddressAPIResponse',
                '/CreateRegulationAddress'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\CreateRegulationAddressAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\CreateRegulationAddressAPIResponse', $e->getResponseHeaders());
     ...
     * @return \backend\modules\voximplant\models\GetAvailibleRegulationsAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param string $phone_category_name The phone category name. (required)
     * @param string $phone_region_code The phone region code. Mandatory for regulation type LOCAL (optional)
     * @return Array of \backend\modules\voximplant\models\GetAvailibleRegulationsAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function getAvailibleRegulationsWithHttpInfo($country_code, $phone_category_name, $phone_region_code = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\GetAvailibleRegulationsAPIResponse',
                '/GetAvailibleRegulations'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\GetAvailibleRegulationsAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\GetAvailibleRegulationsAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \backend\modules\voximplant\models\GetCountriesAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     *
     * @param string $country_code The country code A2 (optional)
     * @return Array of \backend\modules\voximplant\models\GetCountriesAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function getCountriesWithHttpInfo($country_code = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\GetCountriesAPIResponse',
                '/GetCountries'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\GetCountriesAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\GetCountriesAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \backend\modules\voximplant\models\GetRegionsAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param int $count The returned regions count. (optional)
     * @param int $offset The record count to omit. (optional)
     * @return Array of \backend\modules\voximplant\models\GetRegionsAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function getRegionsWithHttpInfo($country_code, $phone_category_name, $city_name = null, $count = null, $offset = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\GetRegionsAPIResponse',
                '/GetRegions'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\GetRegionsAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\GetRegionsAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \backend\modules\voximplant\models\GetRegulationsAddressAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param bool $verified Show only verified regulation address. (optional)
     * @param bool $in_progress Show only in progress regulation address. (optional)
     * @return Array of \backend\modules\voximplant\models\GetRegulationsAddressAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function getRegulationsAddressWithHttpInfo($country_code = null, $phone_category_name = null, $phone_region_code = null, $regulation_address_id = null, $verified = null, $in_progress = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\GetRegulationsAddressAPIResponse',
                '/GetRegulationsAddress'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\GetRegulationsAddressAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\GetRegulationsAddressAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \backend\modules\voximplant\models\GetZIPCodesAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param float $count The max returning record count. (optional)
     * @param float $offset The record count to omit. (optional)
     * @return Array of \backend\modules\voximplant\models\GetZIPCodesAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function getZIPCodesWithHttpInfo($country_code, $phone_region_code = null, $count = null, $offset = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\GetZIPCodesAPIResponse',
                '/GetZIPCodes'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\GetZIPCodesAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\GetZIPCodesAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \backend\modules\voximplant\models\LinkregulationAddressAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param float $phone_id The phone ID for link (required)
     * @param string $phone_number The phone number for link (required)
     * @return Array of \backend\modules\voximplant\models\LinkregulationAddressAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function linkregulationAddressWithHttpInfo($regulation_address_id, $phone_id, $phone_number)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\LinkregulationAddressAPIResponse',
                '/LinkregulationAddress'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\LinkregulationAddressAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\LinkregulationAddressAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
