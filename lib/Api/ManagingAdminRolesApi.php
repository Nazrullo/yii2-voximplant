...
class ManagingAdminRolesApi
{
     ...
     * @return \backend\modules\voximplant\models\AddAdminRoleAPIResponse
     ...
     * @param string $allowed_entries The list of allowed access entries separated by the &#x60;;&#x60; symbol (the API function names). (optional)
     * @param string $denied_entries The list of denied access entries separated by the &#x60;;&#x60; symbol (the API function names). (optional)
     * @return Array of \backend\modules\voximplant\models\AddAdminRoleAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function addAdminRoleWithHttpInfo($admin_role_name, $admin_role_active = null, $like_admin_role_id = null, $like_admin_role_name = null, $allowed_entries = null, $denied_entries = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\AddAdminRoleAPIResponse',
                '/AddAdminRole'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\AddAdminRoleAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\AddAdminRoleAPIResponse', $e->getResponseHeaders());
     ...
     * @return \backend\modules\voximplant\models\GetAdminRolesAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param float $count The max returning record count. (optional)
     * @param float $offset The record count to omit. (optional)
     * @return Array of \backend\modules\voximplant\models\GetAdminRolesAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function getAdminRolesWithHttpInfo($admin_role_id = null, $admin_role_name = null, $admin_role_active = null, $with_entries = null, $with_account_roles = null, $with_parent_roles = null, $with_system_roles = null, $included_admin_user_id = null, $excluded_admin_user_id = null, $full_admin_users_matching = null, $showing_admin_user_id = null, $count = null, $offset = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\GetAdminRolesAPIResponse',
                '/GetAdminRoles'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\GetAdminRolesAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\GetAdminRolesAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
