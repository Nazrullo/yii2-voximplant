...
class ManagingApplicationsApi
{
     ...
     * @return \backend\modules\voximplant\models\AddApplicationAPIResponse
     ...
     * @param string $im_roster_type The roster type (IM users list type). The following values are possible: personal, group. (optional)
     * @param bool $busy_on_call The busy_on_call flag. (optional)
     * @return Array of \backend\modules\voximplant\models\AddApplicationAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function addApplicationWithHttpInfo($application_name, $im_enabled = null, $im_roster_type = null, $busy_on_call = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\AddApplicationAPIResponse',
                '/AddApplication'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\AddApplicationAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\AddApplicationAPIResponse', $e->getResponseHeaders());
     ...
     * @return \backend\modules\voximplant\models\GetApplicationsAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param float $count The max returning record count. (optional)
     * @param float $offset The record count to omit. (optional)
     * @return Array of \backend\modules\voximplant\models\GetApplicationsAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function getApplicationsWithHttpInfo($application_id = null, $application_name = null, $im_enabled = null, $im_roster_type = null, $user_id = null, $excluded_user_id = null, $showing_user_id = null, $with_rules = null, $with_scenarios = null, $count = null, $offset = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\GetApplicationsAPIResponse',
                '/GetApplications'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\GetApplicationsAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\GetApplicationsAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param string $im_roster_type The roster type (IM users list type). The following values are possible: personal, group. (optional)
     * @param bool $busy_on_call The busy_on_call flag. (optional)
     * @return \backend\modules\voximplant\models\SetApplicationInfoAPIResponse
     * @throws ApiException on non-2xx response
     */
     ...
     * @param string $im_roster_type The roster type (IM users list type). The following values are possible: personal, group. (optional)
     * @param bool $busy_on_call The busy_on_call flag. (optional)
     * @return Array of \backend\modules\voximplant\models\SetApplicationInfoAPIResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws ApiException on non-2xx response
     */
    public function setApplicationInfoWithHttpInfo($application_id = null, $required_application_name = null, $application_name = null, $im_enabled = null, $im_roster_type = null, $busy_on_call = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\backend\modules\voximplant\models\SetApplicationInfoAPIResponse',
                '/SetApplicationInfo'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\backend\modules\voximplant\models\SetApplicationInfoAPIResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\backend\modules\voximplant\models\SetApplicationInfoAPIResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
