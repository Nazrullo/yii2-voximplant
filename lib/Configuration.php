...
namespace backend\modules\voximplant\lib;
...
class Configuration
{
    ...
    public static function setInitParams(){
            //ключь апи для для всех методов required
            Configuration::getDefaultConfiguration()->setApiKey('api_key', \Yii::$app->params['api_key']);
            //ид аккаунта для всех методов required
            Configuration::getDefaultConfiguration()->setApiKey('account_id', \Yii::$app->params['account_id']);
    }
}
