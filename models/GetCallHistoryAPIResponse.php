...
class GetCallHistoryAPIResponse implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        'result' => '\backend\modules\voximplant\models\CallSessionInfoType[]',
        'total_count' => 'int',
        'count' => 'int',
        'timezone' => 'string',
    ...
    /**
     * Gets result
     * @return \backend\modules\voximplant\models\CallSessionInfoType[]
     */
    ...
    /**
     * Sets result
     * @param \backend\modules\voximplant\models\CallSessionInfoType[] $result
     * @return $this
     */
